...
import (
	...
	"github.com/barani129/osphealthcheck/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3f431cd4.spark.co.nz",
	...
	if err = (&controller.OsphealthcheckReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Osphealthcheck")
		os.Exit(1)
	}
